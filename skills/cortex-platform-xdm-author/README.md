...
- `assets/` -- the field-anchor synonym index used by `lookup_anchor.py`, the authoritative MITRE ATT&CK crosswalk (`mitre_crosswalk.json`) used by `mitre_map.py`, plus a MAPPED-header template for new rules.
